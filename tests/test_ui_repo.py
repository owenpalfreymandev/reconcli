...
@pytest.mark.parametrize("value, expected", [(0, "0 B"), (999, "999 B"), (1000, "1.0 KB"), (999_999, "1000.0 KB"), (1_000_000, "1.0 MB"), (1_000_000_000, "1.0 GB"), (1_000_000_000_000, "1.0 TB")])
...
def test_bars_scale_and_zero_is_safe():
    full = _contributor_row({"login": "full", "commits": 10}, 10, 10).plain.splitlines()[1]
    half = _contributor_row({"login": "half", "commits": 5}, 10, 10).plain.splitlines()[1]
    zero = _contributor_row({"login": "zero", "commits": 0}, 10, 10).plain.splitlines()[1]
